...
public static class EndPoints
{
    public static class Auth
    {
        ...
        public static class RefreshUserToken
        {
            ...
            public const string Summary = "Refresh Token For User | If You Will Not Send Body, Server Will Read ( JWT,RefreshToken ) From Cookies | Allowed For Basic Role";
        ...
        public static class RevokeUserToken
        {
            ...
            public const string Summary = "Revoke Token For User | If You Will Not Send Body, Server Will Read ( JWT,RefreshToken ) From Cookies | Allowed For Basic Role";
        ...
        public static class GetAllUsers
        {
            ...
            public const string Summary = "Get All Users From Server | This Endpoint Used For BackEnd Developer Only | Allowed For SuperAdmin Role";
        ...
        {
            public const string OperationId = "732A3F62-B9CD-4A2D-AE8E-CE8CD468168A";
            public const string Summary = "Delete All Users From Server | This Endpoint Used For BackEnd Developer Only | Allowed For SuperAdmin Role";
            public const string Description = "This Endpoint Created To Help BackEnd Developer At Development Phase Only";
        }
    }
}
