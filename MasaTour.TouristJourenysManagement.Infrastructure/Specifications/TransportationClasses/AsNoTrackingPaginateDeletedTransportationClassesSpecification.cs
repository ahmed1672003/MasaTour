...
public sealed class AsNoTrackingPaginateDeletedTransportationClassesSpecification : Specification<TransportationClass>
{
    public AsNoTrackingPaginateDeletedTransportationClassesSpecification(int? pageNumber = 1, int? pageSize = 10, string keyWords = "", Expression<Func<TransportationClass, object>> orderBy = null)
        : base(t => (t.IsDeleted) &&
