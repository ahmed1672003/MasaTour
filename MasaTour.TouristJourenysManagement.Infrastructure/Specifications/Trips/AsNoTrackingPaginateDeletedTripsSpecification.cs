...
public sealed class AsNoTrackingPaginateDeletedTripsSpecification : Specification<Trip>
{
    public AsNoTrackingPaginateDeletedTripsSpecification(int? pageNumber = 1, int? pageSize = 10, string keyWords = "", Expression<Func<Trip, object>> orderBy = null)
        : base(t => (t.IsDeleted) &
