...
public class CategoriesController : MasaTourController
{
    ...
    public async Task<IActionResult> UpdateCategory(UpdateCategoryDto dto) =>
        MasaTourResponse(await Mediator.Send(new UpdateCategoryCommand(dto)));
    #endregion
    ...
    public async Task<IActionResult> DeleteCategoryById([Required][MaxLength(36)][MinLength(36)] string categoryId) =>
        MasaTourResponse(await Mediator.Send(new DeleteCategoryByIdCommand(categoryId)));
    ...
    public async Task<IActionResult> UndoDeleteCategoryById([Required] string categoryId) =>
        MasaTourResponse(await Mediator.Send(new UndoDeleteCategoryByIdCommand(categoryId)));
    #endregion
    ...
    public async Task<IActionResult> GetCategoryById([Required][MaxLength(36)][MinLength(36)] string categoryId) =>
        MasaTourResponse(await Mediator.Send(new GetCategoryByIdQuery(categoryId)));
    ...
    public async Task<IActionResult> GetAllCategories() =>
        MasaTourResponse(await Mediator.Send(new GetAllCategoriesQuery()));
    ...
    public async Task<IActionResult> GetAllDeletedCategories() =>
        MasaTourResponse(await Mediator.Send(new GetAllDeletedCategoriesQuery()));
    ...
    public async Task<IActionResult> GetAllUnDeletedCategories() =>
        MasaTourResponse(await Mediator.Send(new GetAllUnDeletedCategoriesQuery()));
    ...
    public async Task<IActionResult> PaginateUnDeletedCategories(int? pageNumber = 1, int? pageSize = 10, string keyWords = "", CategoryOrderBy? orderBy = CategoryOrderBy.CreatedAt) =>
        MasaTourResponse(await Mediator.Send(new PaginateUnDeletedCategoriesQuery(pageNumber, pageSize, keyWords, orderBy)));


    [AllowAnonymous]
    [HttpGet(Router.Category.PaginateDeletedCategories)]
    [Produces(ContentTypes.ApplicationOverJson, Type = typeof(PaginationResponseModel<IEnumerable<GetCategoryDto>>))]
    [SwaggerOperation(OperationId = EndPoints.Category.PaginateDeletedCategories.OperationId, Summary = EndPoints.Category.PaginateDeletedCategories.Summary, Description = EndPoints.Category.PaginateDeletedCategories.Description)]
    public async Task<IActionResult> PaginateDeletedCategories(int? pageNumber = 1, int? pageSize = 10, string keyWords = "", CategoryOrderBy? orderBy = CategoryOrderBy.CreatedAt) =>
        MasaTourResponse(await Mediator.Send(new PaginateDeletedCategoriesQuery(pageNumber, pageSize, keyWords, orderBy)));
    #endregion
}
